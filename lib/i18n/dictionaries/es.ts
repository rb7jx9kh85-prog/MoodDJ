  ...
  app: {
    ...
    options: {
      ...
      ambiance: {
        ...
        positivity: "Luminosidad / positividad",
      },
      style: {
        title: "Estilo musical",
        preferredGenres: "Géneros preferidos",
        excludedGenres: "Géneros excluidos",
        genrePlaceholder: "Escribe un género y pulsa Intro",
        era: "Época",
        ...
        discoveryBalanced: "Equilibrado",
        discoveryAdventurous: "Aventurero",
        discoveryUnderground: "Underground",
        variety: "Variedad de géneros",
      },
      vocals: {
        title: "Voz y letras",
        preference: "Estilo vocal",
        any: "Indiferente",
        mostlyVocal: "Principalmente vocal",
        mostlyInstrumental: "Principalmente instrumental",
        instrumentalOnly: "Solo instrumental",
        female: "Voces femeninas",
        male: "Voces masculinas",
        mixed: "Voces mixtas",
        duets: "Dúos",
        spokenWord: "Voz hablada",
        whisperedBreathy: "Susurrada / entrecortada",
        explicit: "Permitir canciones explícitas",
      },
      selection: {
        title: "Selección de canciones",
        preferredArtists: "Artistas preferidos",
        excludedArtists: "Artistas excluidos",
        artistPlaceholder: "Escribe un artista y pulsa Intro",
        referenceTracks: "Canciones de referencia",
        referenceTracksPlaceholder: "Artista - Canción, luego Intro",
        referenceTracksHint:
          "Se usan para entender el groove, la época y la producción — no son un filtro estricto.",
        remixes: "Permitir remixes",
        liveVersions: "Permitir versiones en vivo",
        covers: "Permitir versiones/covers",
      },
      progression: {
        title: "Progresión de la playlist",
        stable: "Energía estable",
        gradualRise: "Ascenso gradual",
        gradualFall: "Descenso gradual",
        wave: "Ondulante",
        slowBurn: "Slow burn",
        peakAndRelease: "Clímax y relajación",
        cinematicJourney: "Progresión cinematográfica",
      },
      context: {
        title: "Contexto",
        activity: "Actividad",
        activityPlaceholder: "ej. conducción nocturna, entrenamiento, cena",
        timeOfDay: "Momento del día",
        season: "Estación",
        locationAtmosphere: "Lugar o atmósfera",
        locationPlaceholder: "ej. rooftop en Milán, club underground en Berlín",
        customInstructions: "Instrucciones personalizadas",
        customInstructionsPlaceholder: "Algo más que Mood DJ deba saber",
      },
    },
  },
  settings: {
    ...
    plan: "Plan actual",
    referralLink: "Programa de referidos",
    historyLink: "Historial de playlists",
  },
  referral: {
    title: "Invita amigos, gana créditos",
    subtitle: "Comparte tu código — gana créditos de generación cuando un amigo genere su primera playlist.",
    back: "Volver",
    ...
    share: "Compartir",
    shareTitle: "Mood DJ",
    shareMessage: "Uso Mood DJ para convertir cualquier mood en una playlist real de Spotify — pruébalo:",
    sent: "Invitaciones enviadas",
    activated: "Amigos activados",
    creditsBalance: "Saldo de créditos",
    tierExplorer: "Explorer",
    tierCreator: "Creator",
    tierAmbassador: "Ambassador",
    nextTier: "Siguiente nivel",
    verifyEmailPrompt: "Verifica tu email para desbloquear tus créditos de bienvenida.",
    resendVerification: "Reenviar email de verificación",
    verificationSent: "Email de verificación enviado",
    viewLeaderboard: "Ver clasificación entre amigos",
    leaderboardTitle: "Clasificación entre amigos",
    leaderboardEmpty: "Invita a un amigo para iniciar tu clasificación.",
    you: "Tú",
    colReferrals: "Referidos",
    colPlaylists: "Playlists",
    inviteFriendCta: "Invita a un amigo",
    inviteFriendSubtitle: "Comparte esta playlist y gana créditos cuando se una a Mood DJ.",
  },
  history: {
    title: "Tus playlists",
    back: "Volver",
    empty: "Todavía no has generado ninguna playlist.",
    emptyCta: "Genera tu primera playlist",
    pushedBadge: "En Spotify",
    previewBadge: "Solo vista previa",
    tracksSuffix: "canciones",
  },
};
