...
const sv: Dictionary = {
  ...
  settings: {
    ...
    plan: "Nuvarande plan",
    referralLink: "Värvningsprogram",
    historyLink: "Spellistehistorik",
  },
  referral: {
    title: "Värva vänner, tjäna krediter",
    subtitle: "Dela din kod — tjäna genereringskrediter när en vän genererar sin första spellista.",
    back: "Tillbaka",
    ...
    share: "Dela",
    shareTitle: "Mood DJ",
    shareMessage: "Jag använder Mood DJ för att förvandla vilken stämning som helst till en riktig Spotify-spellista — testa:",
    sent: "Skickade inbjudningar",
    activated: "Aktiverade vänner",
    creditsBalance: "Kreditsaldo",
    tierExplorer: "Explorer",
    tierCreator: "Creator",
    tierAmbassador: "Ambassador",
    nextTier: "Nästa nivå",
    verifyEmailPrompt: "Verifiera din e-post för att låsa upp din välkomstbonus.",
    resendVerification: "Skicka verifieringsmejl igen",
    verificationSent: "Verifieringsmejl skickat",
    viewLeaderboard: "Visa topplista för vänner",
    leaderboardTitle: "Topplista för vänner",
    leaderboardEmpty: "Värva en vän för att starta din topplista.",
    you: "Du",
    colReferrals: "Värvningar",
    colPlaylists: "Spellistor",
    inviteFriendCta: "Bjud in en vän",
    inviteFriendSubtitle: "Dela den här spellistan och tjäna krediter när de går med i Mood DJ.",
  },
  history: {
    title: "Dina spellistor",
    back: "Tillbaka",
    empty: "Du har inte genererat några spellistor än.",
    emptyCta: "Generera din första spellista",
    pushedBadge: "På Spotify",
    previewBadge: "Endast förhandsvisning",
    tracksSuffix: "låtar",
  },
};
