...
const fr: Dictionary = {
  ...
  login: {
    ...
    forgotPasswordEmailRequired: "Entre ton adresse email d'abord.",
    forgotPasswordSent: "Si un compte existe avec cette adresse, un email de réinitialisation vient d'être envoyé.",
    emailInUseSwitchToSignIn: "Un compte existe déjà avec cet email — connecte-toi plutôt.",
    stillWorking: "Ça prend plus de temps que prévu. Si la connexion aboutit, tu seras redirigé·e automatiquement.",
    tooManyAttempts: "Trop de tentatives. Réessaie dans {seconds}s.",
  },
  app: {
  ...
  settings: {
    ...
    plan: "Plan actuel",
    referralLink: "Programme de parrainage",
    historyLink: "Historique des playlists",
  },
  referral: {
    title: "Parraine tes amis, gagne des crédits",
    subtitle: "Partage ton code — gagne des crédits de génération quand un ami génère sa première playlist.",
    back: "Retour",
    ...
    share: "Partager",
    shareTitle: "Mood DJ",
    shareMessage: "J'utilise Mood DJ pour transformer n'importe quel mood en vraie playlist Spotify — essaie :",
    sent: "Invitations envoyées",
    activated: "Amis activés",
    creditsBalance: "Solde de crédits",
    tierExplorer: "Explorer",
    tierCreator: "Creator",
    tierAmbassador: "Ambassador",
    nextTier: "Prochain palier",
    verifyEmailPrompt: "Vérifie ton email pour débloquer tes crédits de bienvenue.",
    resendVerification: "Renvoyer l'email de vérification",
    verificationSent: "Email de vérification envoyé",
    viewLeaderboard: "Voir le classement entre amis",
    leaderboardTitle: "Classement entre amis",
    leaderboardEmpty: "Parraine un ami pour démarrer ton classement.",
    you: "Toi",
    colReferrals: "Parrainages",
    colPlaylists: "Playlists",
    inviteFriendCta: "Invite un ami",
    inviteFriendSubtitle: "Partage cette playlist et gagne des crédits quand il rejoint Mood DJ.",
  },
  history: {
    title: "Tes playlists",
    back: "Retour",
    empty: "Tu n'as encore généré aucune playlist.",
    emptyCta: "Génère ta première playlist",
    pushedBadge: "Sur Spotify",
    previewBadge: "Aperçu uniquement",
    tracksSuffix: "titres",
  },
};
